...
class PersonController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('config.person', ["title" => "Participantes"]);
    }
    ...
    {
        return view('modals.person', ["add" => false, "person" => $person]);
    }
    ...
    {
        $validator = $this->validator($request, $person->id);
        $error = $validator->errors();
        if ($error->first()) {
            return response()->json([
                'status' => 400,
            ...
            Person::find($person->id)->update(request()->all());
    ...
    public function validator(Request $request, $id)
    {
        ...
        $rules = [
            ...
            'identification' => ['required',new IdentificatorRule, Rule::unique('persons')->ignore($id)],
