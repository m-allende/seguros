...
<head>
    ...
    @if (
        ...
        @vite(['resources/rtl/scss/light/plugins/perfect-scrollbar/perfect-scrollbar.scss', 'resources/rtl/scss/light/assets/custom.scss', 'resources/rtl/scss/dark/assets/custom.scss'])


        @if (Request::is('rtl/modern-light-menu/*'))
            @vite(['resources/rtl/scss/layouts/vertical-light-menu/light/structure.scss', 'resources/rtl/scss/layouts/vertical-light-menu/dark/structure.scss'])
        @elseif (Request::is('rtl/modern-dark-menu/*'))
            @vite(['resources/rtl/scss/layouts/vertical-dark-menu/light/structure.scss', 'resources/rtl/scss/layouts/vertical-dark-menu/dark/structure.scss'])
        @elseif (Request::is('rtl/collapsible-menu/*'))
            @vite(['resources/rtl/scss/layouts/collapsible-menu/light/structure.scss', 'resources/rtl/scss/layouts/collapsible-menu/dark/structure.scss'])
        @elseif (Request::is('rtl/horizontal-light-menu/*'))
            @vite(['resources/rtl/scss/layouts/horizontal-light-menu/light/structure.scss', 'resources/rtl/scss/layouts/horizontal-light-menu/dark/structure.scss'])
        @elseif (Request::is('rtl/horizontal-dark-menu/*'))
            @vite(['resources/rtl/scss/layouts/horizontal-dark-menu/light/structure.scss', 'resources/rtl/scss/layouts/horizontal-dark-menu/dark/structure.scss'])
        @else
            @vite(['resources/rtl/scss/layouts/vertical-light-menu/light/structure.scss', 'resources/rtl/scss/layouts/vertical-light-menu/dark/structure.scss'])
        @endif
