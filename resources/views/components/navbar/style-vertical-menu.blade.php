...
<div class="header-container {{ $classes }}">
    <header class="header navbar navbar-expand-sm expand-header">
        ...
        <div class="search-animated toggle-search " style="display:none">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <ul class="navbar-item flex-row ms-lg-auto ms-0">
            ...
            <li class="nav-item dropdown notification-dropdown">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="notificationDropdown"
                    onclick="$('.new-notification').remove()" data-bs-toggle="dropdown" aria-haspopup="true"
                    aria-expanded="false">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="notificationDropdown">
                    <div class="notification-scroll">
                        <div class="drodpown-title notification mt-2">
                            @php
                                $cantNoti = sizeof(Auth::user()->notifications);
                            @endphp
                            <h6 class="d-flex justify-content-between"><span
                                    class="align-self-center">Notificaciones</span> <span
                                    class="badge badge-secondary" id="countNewNotification"
                                    data-count="{{ $cantNoti }}">{{ $cantNoti }}
                                    Nuevas</span></h6>
                            ...
                            @foreach (Auth::user()->notifications as $notification)
                                ...
                                @endphp
                                <div class="dropdown-item" id="notification_{{ $notification->id }}">
                                    <div class="media file-upload">
                                        ...
                                        <div class="media-body">
                                            <div class="data-info">
                                                <a href="/config/company/download?filename={{ $obj->filename }}">
                                                    <h6 class="">{{ $obj->filename }}
                                                    </h6>
                                                    <p class="">{{ $obj->location }}</p>
                                                </a>
                                            </div>
                                            <div class="icon-status drop-notification"
                                                data-param1="{{ $notification->id }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="nav-item dropdown user-profile-dropdown  order-lg-0 order-1">
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                    ...
                    <div class="dropdown-item">
                        <a href="/access/user/{{ Auth::user()->id }} ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    ...
                    <div class="dropdown-item">
                        <a href="javascript:void();"
                            ...
                            </svg> <span>Cierra Sesión</span>
                        </a>
                        <form autocomplete="off" id="logout-form" action="{{ route('logout') }}" method="POST"
                            style="display: none;">
                            @csrf
                        </form>
                    </div>
