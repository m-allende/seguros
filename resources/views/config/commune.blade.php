        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.btn-edit', function() {
                    ...
                    var newOption = new Option(rowData.city.region.name, rowData.city.region.id, true, true);
                    $('.select2-region-modal').append(newOption).trigger('change');

                    var newOption2 = new Option(rowData.city.name, rowData.city.id, true, true);
