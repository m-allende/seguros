<x-base-layout :scrollspy="false">
    ...
    <div class="row layout-top-spacing">
        ...
        <div class="seperator-header">
            <h4 class="">@lang('translation.communes')</h4>
        </div>
    ...
    <x-slot:footerFiles>
        <script>
            $(document).on('click', '.btn-add', function() {
                ...
                $('.modal').find('.modal-title').text('Agregar nueva Comuna')
                $('.btn-save').show();
                $('.btn-update').hide()
            })
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.btn-edit', function() {
                    ...
                    modal.find('.modal-title').text('Modificar Comuna')
                    ...
                    let newOption = new Option(rowData.city.region.name, rowData.city.region.id, true, true);
                    $('.select2-region-modal').append(newOption).trigger('change');

                    let newOption2 = new Option(rowData.city.name, rowData.city.id, true, true);
                    $('.select2-city-modal').append(newOption2).trigger('change');
                ...
                $(document).on("click", '.btn-activate',
                    function(event) {
                        ...
                        Swal.fire({
                            title: "¿Desea dejar Vigente esta Comuna?",
                            icon: "warning",
                            showCancelButton: true,
                            confirmButtonText: "@lang('translation.yes')",
                            cancelButtonText: "No",
