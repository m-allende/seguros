        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                btnUpdate.click(function() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/config/typenovehicle/" + updateId,
                        data: formData,
                        success: function(data) {
                            if (data.status == 200) {
                                table.draw();
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                type: "POST",
                                dataType: 'JSON',
                                url: "/config/typenovehicle/" + rowid,
                                data: {
                                    _method: 'delete',
                                    _token: token
                                },
                ...
                $(document).on("click", '.export-excel',
                    function(event) {
                        ...
                        $.ajax({
                            type: "GET",
                            url: "{{ route('typenovehicle.export') }}",
                    ...
                    function(event) {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                $.ajax({
                                    type: "POST",
                                    url: "/config/typenovehicle/activate",
                                    data: "id=" + id,
                                    success: function(datos) {
                                        table.draw();
                                    },
