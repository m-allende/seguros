        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.btn-edit', function() {
                    ...
                    modal.find('.modal-title').text('Modificar Ciudad')
                    ...
                    var newOption = new Option(rowData.region.name, rowData.region.id, true, true);
                    $('.select2-region-model').append(newOption).trigger('change');
                ...
                $(document).on("click", '.btn-activate',
                    function(event) {
                        ...
                        Swal.fire({
                            title: "¿Desea dejar Vigente esta Ciudad?",
                            icon: "warning",
                            showCancelButton: true,
                            confirmButtonText: "Si",
                            cancelButtonText: "No",
